  ...
  return <div ref={ref} className={`flex flex-col items-center ${className}`}>
      ...
      height: '11cm'
        ...
        <div className="p-3 flex flex-col items-center justify-between flex-1">
          ...
          {/* Brand Logo */}
          <div className="flex items-center justify-center mt-1 mx-auto w-fit">
            <img src={doorviiBrandLogo} alt="DoorVii" className="h-16 object-contain" />
          </div>

          {/* Website URL */}
          <p className="text-white text-base font-bold tracking-wide" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.5)' }}>
