                  ...
                  <div className="flex flex-col gap-3 w-full">
                    ...
                    {ownerPhone && (
                      <Button
                        variant="ghost"
                        size="lg"
                        className="text-white hover:bg-white/20 w-full border border-[#25D366]/50 flex items-center justify-center gap-2"
                        onClick={() => {
                          const phone = ownerPhone.replace(/\D/g, '');
                          const message = encodeURIComponent(`Olá! Estou na porta - ${doorbellPropertyName}`);
